...
public class TransactionTest extends TestUtil.CreateHeapFile {
  ...
  /**
   * A transaction that acquires no locks should still be able to 
   * complete successfully.
   * @throws IOException 
   * 
   */
  @Test public void testTransactionNoLocks() throws IOException {
	  TransactionId tid = new TransactionId();
	  bp.transactionComplete(tid);
	  
	  assert(true); // if got here, no errors occured
  }
